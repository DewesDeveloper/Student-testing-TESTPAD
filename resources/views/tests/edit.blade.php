					...
					<template x-for="(question, qIndex) in questions" :key="qIndex">
						<div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden"
							...
							<div class="p-6">
								...
								<!-- ВКЛАДКА: КОММЕНТАРИЙ -->
								<div x-show="tab === 'comment'" x-transition x-cloak>
								...
								<!-- ВКЛАДКА: ПАРАМЕТРЫ -->
								<div x-show="tab === 'params'" x-transition x-cloak>
									<div class="space-y-3 p-4 text-sm text-gray-600">
										<label class="flex items-center gap-3 cursor-pointer">
											<input type="checkbox" :name="`questions[${qIndex}][is_required]`" :checked="question.is_required" class="w-4 h-4 text-blue-600">
											<span>Обязательный вопрос</span>
										</label>
										<label class="flex items-center gap-3 cursor-pointer">
											<input type="checkbox" :name="`questions[${qIndex}][shuffle_options]`" :checked="question.shuffle_options" class="w-4 h-4 text-blue-600">
